...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    if ($response->itemAt('status') == 'success') {
        exit(GemMailApi_Json::encode(array(
            'status'    => 'success',
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://gerenciador.gemmail.com.br/backend/assets/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="https://gerenciador.gemmail.com.br/backend/assets/css/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="https://gerenciador.gemmail.com.br/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="https://gerenciador.gemmail.com.br/backend/assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="https://gerenciador.gemmail.com.br/favicon.ico" type="image/x-icon" /> 
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by GemMail.
