...
$response = $endpoint->create(array(
    'name'          => 'Campanha criada pela API', // required
    'type'          => 'regular', // optional: regular or autoresponder
    'from_name'     => 'Nome da Empresa', // required
    'from_email'    => 'empresa@email.com', // required
    'subject'       => 'Título da campanha via API', // required
    'reply_to'      => 'empresa@email.com', // required
...
$response = $endpoint->update('CAMPAIGN-UNIQUE-ID', array(
    'name'          => 'Campanha atualizada pela API', // optional at update
    'from_name'     => 'Nome da Empresa', // optional at update
    'from_email'    => 'empresa@email.com', // optional at update
    'subject'       => 'Testando update de campanhas pela API', // optional at update
    'reply_to'      => 'empresa@email.com', // optional at update
