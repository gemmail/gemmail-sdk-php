<?php
/**
 * This file contains the configuration class for the GemMailApi PHP-SDK.
 *
...
/**
 * GemMailApi_Config contains the configuration class that is injected at runtime into the main application. 
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Config extends GemMailApi_Base
{
    /**
