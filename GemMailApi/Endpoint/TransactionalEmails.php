<?php
/**
 * This file contains the transactional emails endpoint for GemMailApi PHP-SDK.
 * 
...
/**
 * GemMailApi_Endpoint_TransactionalEmails handles all the API calls for transactional emails.
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Endpoint_TransactionalEmails extends GemMailApi_Base
{
    /**
