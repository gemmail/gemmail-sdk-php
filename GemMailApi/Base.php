<?php
/**
 * This file contains the base class for the GemMailApi PHP-SDK.
 *
...
/**
 * GemMailApi_Base is the base class for all the other classes used in the sdk.
 * 
...
class GemMailApi_Base
{
    ...
    /**
     * @var GemMailApi_Config the configuration object injected into the application at runtime  
     */
    private static $_config;
    
    /**
     * @var GemMailApi_Params the package registry that will hold various components
     */
    private static $_registry = array();
    
    /**
     * @var GemMailApi_Params the registered event handlers
     */
     ...
     * 
     * @param GemMailApi_Config $config
     */
    public static function setConfig(GemMailApi_Config $config)
    {
        self::$_config = $config;
    }
     ...
     * 
     * @return GemMailApi_Params
     */
    public function getRegistry()
    {
        if (!(self::$_registry instanceof GemMailApi_Params)) {
            self::$_registry = new GemMailApi_Params(self::$_registry);
        }
    ...
    public function setComponent($componentName, array $config)
    {
        ...
        if ($component instanceof GemMailApi_Base) {
    ...
    {
        if (!(self::$_eventHandlers instanceof GemMailApi_Params)) {
            self::$_eventHandlers = new GemMailApi_Params(self::$_eventHandlers);
        }
        
        if (!self::$_eventHandlers->contains($eventName) || !(self::$_eventHandlers->itemAt($eventName) instanceof GemMailApi_Params)) {
            self::$_eventHandlers->add($eventName, new GemMailApi_Params());
        }
