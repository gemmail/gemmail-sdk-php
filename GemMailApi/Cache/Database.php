<?php
/**
 * This file contains the Database cache class used in the GemMailApi PHP-SDK.
 * 
...
/**
 * GemMailApi_Cache_Database makes use of the PHP's {@link PDO} extension in order to cache data into a database.
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Cache_Database extends GemMailApi_Cache_Abstract
{
    /**
     ...
     * @return GemMailApi_Cache_Database
     */
