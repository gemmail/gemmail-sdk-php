...
/**
 * GemMailApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Cache_Xcache extends GemMailApi_Cache_Abstract
{
    /**
