<?php
/**
 * This file contains the File cache class used in the GemMailApi PHP-SDK.
 * 
...
/**
 * GemMailApi_Cache_File makes use of the file system in order to cache data.
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Cache_File extends GemMailApi_Cache_Abstract
{
    /**
