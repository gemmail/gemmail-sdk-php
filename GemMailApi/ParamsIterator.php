...
/**
 * GemMailApi_ParamsIterator implements an interator for {@link GemMailApi_Params}.
 *
 * It allows GemMailApi_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class GemMailApi_ParamsIterator implements Iterator
{
	/**
