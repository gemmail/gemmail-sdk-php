<?php
/**
 * This file contains the GemMailApi_Http_Client class used in the GemMailApi PHP-SDK.
 * 
...
/**
 * GemMailApi_Http_Client is the http client interface used to make the remote requests and receive the responses.
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Http_Client extends GemMailApi_Base
{
    /**
    ...
    /**
     * @var GemMailApi_Params the GET params sent in the request.
     */
    public $paramsGet = array();
    
    /**
     * @var GemMailApi_Params the POST params sent in the request.
     */
    public $paramsPost = array();
    
    /**
     * @var GemMailApi_Params the PUT params sent in the request.
     */
    public $paramsPut = array();
    
    /**
     * @var GemMailApi_Params the DELETE params sent in the request.
     */
    public $paramsDelete = array();
    
    /**
     * @var GemMailApi_Params the headers sent in the request.
     */
    ...
    public function __construct(array $options = array())
    {
        ...
        foreach (array('paramsGet', 'paramsPost', 'paramsPut', 'paramsDelete', 'headers') as $param) {
            if (!($this->$param instanceof GemMailApi_Params)) {
                $this->$param = new GemMailApi_Params($this->$param);
            }
        }
    }
    ...
    {
        $request = new GemMailApi_Http_Request($this);
