<?php
/**
 * This file contains the GemMailApi_Http_Response class used in the GemMailApi PHP-SDK.
 * 
...
/**
 * GemMailApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 ...
 * @since 1.0
 */
class GemMailApi_Http_Response extends GemMailApi_Base
{
    /**
    ...
    /**
     * @var GemMailApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var GemMailApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var GemMailApi_Params $body the body of the response.
     */
    public $body;
     ...
     * Contructor.
     * 
     * @param GemMailApi_Http_Request $request
     */
    public function __construct(GemMailApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new GemMailApi_Params($params);
        }
